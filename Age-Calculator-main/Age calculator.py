...
name = tk.Label(text = "Name",font=5)
name.grid(column=0,row=1)
year = tk.Label(text = "Year",font=5)
year.grid(column=0,row=2)
month = tk.Label(text = "Month",font=5)
month.grid(column=0,row=3)
date = tk.Label(text = "Day",font=5)
date.grid(column=0,row=4)

nameEntry = tk.Entry()
nameEntry.grid(column=2,row=1)
yearEntry = tk.Entry()
yearEntry.grid(column=2,row=2)
monthEntry = tk.Entry()
monthEntry.grid(column=2,row=3)
dateEntry = tk.Entry()
dateEntry.grid(column=2,row=4)
